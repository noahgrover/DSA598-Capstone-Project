...
An in-depth description, as well as justification, methodology, and discussion of results is located in the main branch of this repository: `DSA598_capstoneProjectDocumentation_Grover.pdf`. All data comes directly from the Digital Public Library of America (DPLA) API endpoint: (https://api.dp.la/v2/items) 
